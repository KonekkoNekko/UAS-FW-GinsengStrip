        ...
        <div class="row justify-content-center mb-5">
            ...
            <?php $__currentLoopData = $cartContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-2">
                            <img src="<?php echo e(Vite::asset('resources/images/bld.png')); ?>" class="img-thumbnail rounded-start"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 d-grid">
                    <a href="<?php echo e(route('delivery.show')); ?>" class="btn btn-outline-primary btn-lg fs-2 align-self-center">
...
<?php /**PATH /Users/andhikajuliawan/AJE/CODE/asdos/UAS-FW-GinsengStrip/resources/views/customer/cart/index.blade.php ENDPATH**/ ?>